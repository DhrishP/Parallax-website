...
const heroImgContainer = document.querySelector(".heroImgContainer")
...
window.addEventListener("scroll", ()=>{
  ...
  heroTextContainer.style.transform= `translateY(${offsetY * 0.1}px)`
  heroImgContainer.style.transform= `translate(${offsetY * 0.4}px, ${offsetY * 0.7}px)`
